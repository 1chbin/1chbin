# 👋 Hi there, I'm Joaquin Allue

<div align="center">
  
### Full Stack Developer | UI/UX Enthusiast | Visual Design Advocate

*Passionate about crafting beautiful, user-centric web experiences*

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/joaquin-allue-b3a60a272/)
...
I'm a **Full Stack Developer** with a strong passion for **Front-End development** and creating visually stunning user interfaces. I believe that great design is not just about aesthetics—it's about creating seamless, intuitive experiences that users love.

```javascript
const joaquin = {
  location: "Buenos Aires, Argentina 🇦🇷",
  currentFocus: "Building beautiful, functional web applications",
  learning: ["AI Automations", "Advanced UI/UX patterns"],
...
✨ **Visual Excellence** - Creating interfaces that are not just functional, but beautiful  
🚀 **Full Stack Capability** - From database to deployment, I handle it all  
🎨 **Design-First Mindset** - User experience is at the heart of everything I build  
